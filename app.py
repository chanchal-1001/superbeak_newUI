...
class Superbeak:
    def __init__(self):
        ...
        self.image7 = tk.PhotoImage(file = "images/send.png")
        self.set_the_key_img = tk.PhotoImage(file = "images/set_the_key.png")
        self.filesDetails = []
        self.file_S_no = 0
        self.table = []       
        ...
        image1 = tk.PhotoImage(file = "images/reset_key.png")  
        ...
        image3 = tk.PhotoImage(file = "images/start_processing.png")
        ...
        image4 = tk.PhotoImage(file = "images/reload.png")
        ...
        image2 = tk.PhotoImage(file = "images/select_dir.png")
        ...
        image5 = tk.PhotoImage(file = "images/click_start.png")
...
class KeySet:
    def __init__(self):
        ...
        self.resetKeyWindow.iconbitmap("images/superbeak.ico")
        self.set_the_key_img = tk.PhotoImage(file = "images/set_the_key.png")       
